                                ...
                                <ul id="ulMenuAdminPerfilList" class="ulMenu" type="none">
                                    ...
                                    <li id="liUsuarioPerfilList" class="liMenu">
                                        ...
                                        <ul id="ulSubMenuUsuarioPerfilList" class="margin ulSubMenu" type="none">
                                            <li id="liSubMenuInsereUsuarioPerfilList" class="liSubMenu"><a href="telaAdmin_inserirUsuario.jsp"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Inserir Usuário</a></li>
                                            <li id="liSubMenuListaUsuarioPerfilList" class="liSubMenu"><a href="lista_usuarios.jsp"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Listar Usuário</a></li>
                                        </ul>
                                    </li>
