                                ...
                                <ul id="ulMenuAdminClientInsert" class="ulMenu" type="none">
                                    ...
                                    <li id="liUsuarioClientInsert" class="liMenu">
                                        ...
                                        <ul id="ulSubMenuUsuarioClientInsert" class="margin ulSubMenu" type="none">
                                            <li id="liSubMenuInsereUsuarioClientInsert" class="liSubMenu"><a href="telaAdmin_inserirUsuario.jsp"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Inserir Usuário</a></li>
                                            <li id="liSubMenuListaUsuarioClientInsert" class="liSubMenu"><a href="lista_usuarios.jsp"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Listar Usuário</a></li>
                                        </ul>
                                    </li>
