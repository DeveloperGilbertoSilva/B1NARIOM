                                ...
                                <ul id="ulMenuAdminPerfilInsert" class="ulMenu" type="none">
                                    ...
                                    <li id="liUsuarioPerfilInsert" class="liMenu">
                                        ...
                                        <ul id="ulSubMenuUsuarioPerfilInsert" class="margin ulSubMenu" type="none">
                                            <li id="liSubMenuInsereUsuarioPerfilInsert" class="liSubMenu"><a href="telaAdmin_inserirUsuario.jsp"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Inserir Usuário</a></li>
                                            <li id="liSubMenuListaUsuarioPerfilInsert" class="liSubMenu"><a href="lista_usuarios.jsp"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Listar Usuário</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="liPerfilPerfilInsert" class="liMenu">
                                        ...
                                        <ul id="ulSubMenuPerfilPerfilInsert" class="margin ulSubMenu" type="none">
                                            <li id="liSubMenuListaPerfilPerfilInsert" class="liSubMenu"><a href="lista_perfis.jsp"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Listar Perfil</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
