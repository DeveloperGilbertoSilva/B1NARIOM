                                ...
                                <ul id="ulMenuAdminPerfilUpdate" class="ulMenu" type="none">
                                    ...
                                    <li id="liUsuarioPerfilUpdate" class="liMenu">
                                        ...
                                        <ul id="ulSubMenuUsuarioPerfilUpdate" class="margin ulSubMenu" type="none">
                                            <li id="liSubMenuInsereUsuarioPerfilUpdate" class="liSubMenu"><a href="telaAdmin_inserirUsuario.jsp"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Inserir Usuário</a></li>
                                            <li id="liSubMenuListaUsuarioPerfilUpdate" class="liSubMenu"><a href="lista_usuarios.jsp"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Listar Usuário</a></li>
                                        </ul>
                                    </li>
