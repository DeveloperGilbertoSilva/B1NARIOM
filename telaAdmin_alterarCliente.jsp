                                ...
                                <ul id="ulMenuAdminClientUpdate" class="ulMenu" type="none">
                                    ...
                                    <li id="liUsuarioClientUpdate" class="liMenu">
                                        ...
                                        <ul id="ulSubMenuUsuarioClientUpdate" class="margin ulSubMenu" type="none">
                                            <li id="liSubMenuInsereUsuarioClientUpdate" class="liSubMenu"><a href="telaAdmin_inserirUsuario.jsp"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Inserir Usuário</a></li>
                                            <li id="liSubMenuListaUsuarioClientUpdate" class="liSubMenu"><a href="lista_usuarios.jsp"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Listar Usuário</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="liPerfilClientUpdate" class="liMenu">
                                        ...
                                        <ul id="ulSubMenuPerfilClientUpdate" class="margin ulSubMenu" type="none">
                                            ...
                                            <li id="liSubMenuListaPerfilClientUpdate" class="liSubMenu"><a href="lista_perfis.jsp"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Listar Perfil</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
