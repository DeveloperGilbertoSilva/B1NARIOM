...
<div class="container-fluid">
  ...
  <div class="row"> 
    <section id="sectionOpenChamado" class="col-xs-12 position section">
      <h1 id="title_openChamado" class="position center title_openChamadoClass">Para abrir um chamado digite a sua Matrícula:</h1>
      <div id="menu_openChamado" class="position center menu_indexClass menu_openChamadoClass">
        <i class="fa fa-user-circle " aria-hidden="true"></i>
        <input type="text" name="cMatricula" class="position menu_openChamadoInputClass">
        <div id="divBtnOpenChamado" class="position center divBtnOpenChamadoClass">
          <i class="fa fa-phone" aria-hidden="true"></i>
          <input type="submit" name="btnAbrirChamado" class="position" value="Abrir Chamado">
        </div>
    	</div>
