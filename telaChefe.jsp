            ...
            <section id="sectionChefe" class="section">
                ...
                <div id="divControleChamadoChefe" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        ...
                        <div id="menuControleChamadoChefe" class="menuControleChamado col-xs-12">
                            <nav id="navControleChamadoChefe" class="navControleChamado">
                                <ul id="ulControleChamadoChefe" class="ulControleChamado" type="none">
                                    <li id="liAbertoChefe" class="liControle"><a href="#"><i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;&nbsp;Abertos</a></li>
                                    <li id="liAndamentoChefe" class="liControle"><a href="#"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Em andamento</a></li>
                                    <li id="liConcluidoChefe" class="liControle"><a href="#"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;&nbsp;Concluídos</a></li>
                                    <li id="liCanceladoChefe" class="liControle"><a href="#"><i class="fa fa-times-circle" aria-hidden="true"></i>&nbsp;&nbsp;Cancelados</a></li>
                                </ul>
                            </nav>
                            <div id="totalChamadoChefe" class="margin totalChamado">Total de Chamados:</div>
                        </div>
                    </div>
                </div>
                <!--==============================================-->
